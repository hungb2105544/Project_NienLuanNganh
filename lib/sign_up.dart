...
class _SignUpState extends State<SignUp> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      final favoriteManager = context.read<FavoriteProductManager>();
      ...
      // Tạo bản ghi favorite_products cho người dùng mới
      final user =
          authService.currentUser; // Giả định AuthService có getter currentUser
      if (user != null) {
        await favoriteManager.createFavoriteProductRecord(user);
      } else {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
                'Đăng ký thành công, giỏ hàng và danh sách yêu thích đã được tạo!'),
